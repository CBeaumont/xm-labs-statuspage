...
if( callback.response.toLowerCase() == 'create statuspage.io incident' ) {
    ...
    // If you want to use a ServiceNow Incident ID instead then you can replace the active statusPageDate entry with the inactive one below.
    // Note: you will also need to make a similar change to the Update and Resolve entries within this script.
